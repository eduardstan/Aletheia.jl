...
| --- | ---: | ---: |
| Aletheia bridge scalar-data | 1.256 → 0.837692 ms; 14,371 / 4,117,952 -> 12,965 / 3,996,384 | 15.252 → 12.392351 ms; 117,507 / 21,725,888 -> 116,101 / 21,604,320 |
| Aletheia bridge vectorized scalar-data | 0.683 → 0.551409 ms; 7,427 / 1,384,256 -> 5,797 / 1,251,936 | 16.148 → 12.210990 ms; 110,563 / 18,992,192 -> 108,933 / 18,859,872 |
| Aletheia dense scalar-data | 1.268 → 0.848908 ms; 14,371 / 4,117,952 -> 12,965 / 3,996,384 | 17.244 → 12.152724 ms; 117,507 / 21,725,888 -> 116,101 / 21,604,320 |
| Aletheia dense vectorized scalar-data | 0.871 → 0.532821 ms; 7,427 / 1,384,256 -> 4,529 / 635,056 | 16.019 → 13.395217 ms; 110,563 / 18,882,448 -> 10,975 / 1,735,552 |
| Aletheia scalar callback | 1.249 → 0.793713 ms; 14,358 / 3,759,120 -> 12,369 / 3,607,984 | 15.958 → 1.427481 ms; 117,494 / 21,367,056 -> 18,815 / 4,708,480 |
| Aletheia vectorized batch callback | 0.749 → 0.444131 ms; 7,414 / 1,274,512 -> 4,529 / 635,056 | 18.235 → 1.016790 ms; 110,550 / 18,882,448 -> 10,975 / 1,735,552 |
| decision-list apply | 4.348 → 3.697013 ms; 36,515 / 1,415,616 -> 36,693 / 1,421,888 | 11.128 → 9.078128 ms; 109,330 / 6,100,080 -> 110,135 / 6,103,200 |
| deployed modal-tree apply | 0.192 → 0.056655 ms; 470 / 34,016 -> 470 / 34,016 | 0.074 → 0.075491 ms; 470 / 34,016 -> 470 / 34,016 |
| Sole formula-check | 10.524 → 8.323756 ms; 103,127 / 4,028,272 -> 103,127 / 4,028,272 | 18.743 → 15.593314 ms; 222,979 / 10,762,736 -> 222,979 / 10,762,736 |
| supported-warm | 10.524 → 8.323756 ms; 103,127 / 4,028,272 -> 103,127 / 4,028,272 | 18.743 → 15.593314 ms; 222,979 / 10,762,736 -> 222,979 / 10,762,736 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 32 × 8 | 8.804 → 7.640978 / 23.152 → 18.992776 ms | 1.933 → 1.457623 / 41.266 → 2.654643 ms | 1.645 → 0.833059 / 36.654 → 1.491953 ms | 77,398 / 2,971,376 -> 77,754 / 2,983,920 | 28,661 / 7,498,528 -> 24,560 / 7,187,392 | 14,773 / 2,529,312 -> 8,880 / 1,241,536 | 230,125 / 12,692,424 -> 231,828 / 12,713,904 | 234,933 / 42,714,400 -> 31,006 / 8,287,888 | 221,045 / 37,745,184 -> 15,326 / 2,342,032 |
| 64 × 8 | 14.168 → 11.827071 / 38.021 → 31.065180 ms | 8.157 → 3.557191 / 79.684 → 3.809853 ms | 3.051 → 1.575473 / 77.516 → 2.206211 ms | 122,406 / 4,703,056 -> 123,064 / 4,726,224 | 57,273 / 14,982,240 -> 48,944 / 14,346,432 | 29,497 / 5,043,808 -> 17,584 / 2,454,720 | 386,732 / 21,870,384 -> 389,674 / 21,927,360 | 469,817 / 85,413,984 -> 55,390 / 15,446,928 | 442,041 / 75,475,552 -> 24,030 / 3,555,216 |
| 128 × 8 | 23.382 → 18.582766 / 66.419 → 50.236266 ms | 16.619 → 9.231853 / 185.868 → 10.393085 ms | 7.559 → 3.606803 / 166.299 → 4.658823 ms | 195,544 / 7,555,704 -> 196,590 / 7,592,440 | 114,489 / 29,940,416 -> 97,712 / 28,664,736 | 58,937 / 10,063,552 -> 34,992 / 4,881,312 | 666,596 / 38,011,568 -> 671,308 / 38,095,144 | 939,577 / 170,803,904 -> 104,158 / 29,765,232 | 884,025 / 150,927,040 -> 41,438 / 5,981,808 |
