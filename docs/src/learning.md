...
`[`AletheiaLearn`](learning.md)` provides the ILP syntax, bounded refinement operators,
interpretation wrappers, and scoring protocol over the shared `[`AletheiaCore`](api.md)`
