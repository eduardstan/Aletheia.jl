...
working: Done: dimensional successor optimization, IA3/IA7/RCC5 support, compatibility aliases, exhaustive tests, benchmark sweep, profiler evidence, docs build, differential checks, and direct PR #20 (https://github.com/eduardstan/Aletheia.jl/pull/20); remaining: monitor CI and review.
